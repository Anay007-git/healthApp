...
export default defineConfig(({ mode }) => {
  ...
  const databaseUrl = env.DATABASE_URL || process.env.DATABASE_URL || "postgresql://neondb_owner:npg_p01qwhLgRorF@ep-gentle-king-axtrdlfg.c-4.us-east-2.aws.neon.tech/neondb?sslmode=require";
